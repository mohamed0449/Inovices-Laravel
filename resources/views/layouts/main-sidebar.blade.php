...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'home')) }}" style="display: flex; align-items: center; text-decoration: none;">
            <span style="font-size: 20px; color: #000; font-weight: bold;">Fudou</span>
            <img src="{{ URL::asset('assets/img/brand/favicon.png') }}" class="main-logo" alt="logo" style="height: 40px; margin-right: 10px;">
        </a>
